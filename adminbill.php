            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Bill Folder </h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="dashStudent.php">Dashboard</a></li>
                            <li class="breadcrumb-item active">Bill Folder</li>
                        </ol>
                        <!-----List of receipt----->
                        <form action="billdetails.php" method="post">
                            <?php
                            include("dbconn.php");
                            $sql = "SELECT * FROM bill ORDER BY billNo DESC";
                            ...
                            if($row > 0)
                            {
                                while($bill = mysqli_fetch_assoc($result)) {
                                    ...
                                    echo "<button type=submit name=billNo value='".$bill["billNo"]."' >" .$bill["billNo"].". | ".$bill["billName"]."</button><br><br>";  
                                }
                            }
                            else{
                                echo "There is no bill";
                            }?>
                            <!-----List of receipt----->
                        </form>   
                    </div>
