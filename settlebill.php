                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active">Outstanding bill</li>
                        </ol>
                        <!----- All unpaid bill for a student ----->
                        <?php
                            include("dbconn.php");
                            
                            $sql = "SELECT A.studentBillNo, D.billDate, D.billName, D.amount, D.deadline, A.statusID, C.statusName, A.receipt FROM studentbill A, student B, status C, bill D WHERE A.studentID = B.studentID AND A.statusID = C.statusID AND A.billNo = D.billNo AND A.studentID = '$studentID' AND A.statusID = 1 ORDER BY studentBillNo DESC";
                            ...
                            if(mysqli_num_rows($qry) > 0)
                            {
                                ...
                                echo "There is no outstanding bill for now.";
                            ?>
                        <!----- All unpaid bill for a student ----->
                    </div>
                </main>
